...
const resources = {
  en: {
    translation: {
      ...
      face1Desc: '😍 Love it — I like this person a lot',
      face2Desc: '😊 Like — I like this person',
      face3Desc: '😐 Neutral',
      face4Desc: '😞 Dislike — Did not enjoy their company',
      face5Desc: '😢 Strong dislike — Strongly disliked',
      ...
      connectRequestRejected: 'Declined',
      // Incoming connection requests
      pendingConnectionRequests: 'Connection Requests',
      connectionRequestFrom: '{{name}} wants to connect with you',
      acceptRequest: 'Accept',
      rejectRequest: 'Decline',
      connectionAccepted: 'Connection accepted!',
      connectionRejected: 'Connection declined.',
      phoneRevealedAlert: '🎉 {{name}} accepted your request! Their phone number is now available.',
      phoneNumber: 'Phone',
      callOrWhatsApp: 'Call / WhatsApp',
      noIncomingRequests: 'No pending connection requests.',
  ...
  ar: {
    translation: {
      ...
      face1Desc: '😍 رائع — أعجبني هذا الشخص كثيراً',
      face2Desc: '😊 جيد — أعجبني هذا الشخص',
      face3Desc: '😐 محايد',
      face4Desc: '😞 لم يعجبني — لم أستمتع بالتواجد معه',
      face5Desc: '😢 سيء جداً — لم يعجبني إطلاقاً',
      ...
      connectRequestRejected: 'مرفوض',
      pendingConnectionRequests: 'طلبات التواصل',
      connectionRequestFrom: '{{name}} يريد التواصل معك',
      acceptRequest: 'قبول',
      rejectRequest: 'رفض',
      connectionAccepted: 'تم قبول الطلب!',
      connectionRejected: 'تم رفض الطلب.',
      phoneRevealedAlert: '🎉 قبل {{name}} طلبك! رقم هاتفه متاح الآن.',
      phoneNumber: 'الهاتف',
      callOrWhatsApp: 'اتصال / واتساب',
      noIncomingRequests: 'لا توجد طلبات تواصل معلقة.',
